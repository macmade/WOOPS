...
// Internal namespace
namespace Woops\Midi\Binary\File\Resource;

/**
 * MIDI binary file resource stream
 * 
 * @author      Jean-David Gadina <macmade@eosgarden.com>
 * @version     1.0
 * @package     Woops.Midi.Binary.File.Resource
 */
class Stream extends \Woops\Midi\Binary\Stream
{
    /**
     ...
     * @return  void
     * @see     Woops\Midi\Binary\Stream::__construct
     */
