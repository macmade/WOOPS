...
/**
 * FLV binary file resource stream
 * 
 * @author      Jean-David Gadina - www.xs-labs.com
 * @version     1.0
 * @package     Woops.Flv.Binary.File.Resource
 */
class Woops_Flv_Binary_File_Resource_Stream extends Woops_Flv_Binary_Stream
{
    /**
    ...
    public function __construct( $handle, $closeHandle = true )
    {
        ...
        if( !is_resource( $handle ) ) {
            ...
            throw new Woops_Flv_Binary_File_Resource_Stream_Exception(
                'Passed argument must be a valid file handle',
                Woops_Flv_Binary_File_Resource_Stream_Exception::EXCEPTION_NO_RESOURCE
            );
        }
