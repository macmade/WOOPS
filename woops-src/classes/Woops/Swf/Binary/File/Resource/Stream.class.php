 ...
 */
class Woops_Swf_Binary_File_Resource_Stream extends Woops_Swf_Binary_Stream
{
    /**
    ...
    public function __construct( $handle, $closeHandle = true )
    {
        ...
        if( !is_resource( $handle ) ) {
            ...
            throw new Woops_Swf_Binary_File_Resource_Stream_Exception(
                'Passed argument must be a valid file handle',
                Woops_Swf_Binary_File_Resource_Stream_Exception::EXCEPTION_NO_RESOURCE
            );
        }
