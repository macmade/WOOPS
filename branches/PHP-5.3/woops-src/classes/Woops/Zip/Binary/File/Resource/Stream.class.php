...
/**
 * ZIP binary file resource stream
 * 
 * @author      Jean-David Gadina <macmade@eosgarden.com>
 * @version     1.0
 * @package     Woops.Zip.Binary.File.Resource
 */
class Woops_Zip_Binary_File_Resource_Stream extends Woops_Zip_Binary_Stream
{
    /**
    ...
    public function __construct( $handle, $closeHandle = true )
    {
        ...
        if( !is_resource( $handle ) ) {
            ...
            throw new Woops_Zip_Binary_File_Resource_Stream_Exception(
                'Passed argument must be a valid file handle',
                Woops_Zip_Binary_File_Resource_Stream_Exception::EXCEPTION_NO_RESOURCE
            );
        }
