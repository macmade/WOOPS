...
class Parser extends \Woops\Core\Object
{
    ...
    public static function registerProcessingInstructionHandler( $name, $className )
    {
        ...
        if( !is_array( $interfaces )
            || !isset( $interfaces[ 'Woops\Xhtml\ProcessingInstruction\Handler\Interface' ] )
        ) {
            
            throw new Parser\Exception(
                'The class \'' . $className . '\' is not a valid processing instruction handler, since it does not implement the \'Woops\Xhtml\ProcessingInstruction\Handler\Interface\' interface',
